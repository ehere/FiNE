            ...
            <div class="col-md-12">
                ...
                <table class="shopping-cart">
                    ...
                    <tr>
                        ...
                        <td class="image"><a href="page-product-details.html"><img src="<%= F.asset("img/product1.jpg") %>" alt="Item Name"></a></td>
            ...
            <div class="col-md-4  col-md-offset-0 col-sm-6 col-sm-offset-6">
                <div class="cart-promo-code">
                    ...
                    <div class="input-group">
                        <input class="form-control input-sm" id="appendedInputButton" type="text" value="" disabled>
                ...
                <div class="cart-shippment-options">
                    ...
                    <div class="input-append">
                        <select class="form-control input-sm" disabled>
                            <option value="1">Sent to your account</option>
                        </select>
                    </div>
                </div>
            </div>
